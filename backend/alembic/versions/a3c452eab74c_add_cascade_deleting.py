...
def upgrade() -> None:
    ...
    op.drop_constraint(
        "analysis_playlist_version_id_fkey", "analysis", type_="foreignkey"
    )
    ...
    op.drop_constraint(
        "playlist_version_playlist_id_fkey", "playlist_version", type_="foreignkey"
    )
    op.create_foreign_key(
        None,
        "playlist_version",
    ...
    op.drop_constraint(
        "track_features_track_id_fkey", "track_features", type_="foreignkey"
    )
    op.create_foreign_key(
        None, "track_features", "track", ["track_id"], ["track_id"], ondelete="CASCADE"
    )
...
def downgrade() -> None:
    ...
    op.create_foreign_key(
        "playlist_version_playlist_id_fkey",
        "playlist_version",
        "playlist",
        ["playlist_id"],
        ["playlist_id"],
    ...
    op.create_foreign_key(
        "analysis_playlist_version_id_fkey",
        "analysis",
        "playlist_version",
        ["playlist_version_id"],
        ["version_id"],
